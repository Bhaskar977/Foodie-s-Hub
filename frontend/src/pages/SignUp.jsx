    ...
    return (
        <div className='container mt-3'>
            ...
            <div className="mb-3 row">
                <label for="static" className="col-sm-2 col-form-label">Name</label>
            ...
            <div className="mb-3 row">
                ...
                <div className="col-sm-6">
                    <input type="password" className="form-control" name="address" value={credentials.geolocation} id="address" onChange={handleChange} />
                </div>
            </div>
